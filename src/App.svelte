...
<main class="container mx-auto p-4 max-w-2xl">
    ...
    <nav class="flex gap-2 mb-6 overflow-x-auto pb-2">
        {#each Object.keys(renderers) as id}
            <button 
                class="px-4 py-2 rounded-lg transition-colors {$currentTask == id ? 'bg-indigo-600 text-white' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'}"
    ...
    {#if $currentTask}
        <section class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 mb-8">
            ...
            <div class="task-content prose prose-indigo">
