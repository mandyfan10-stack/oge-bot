                    ...
                    <div in:premiumFly class="space-y-10">
                        ...
                        <div class="space-y-6 pt-6">
                            ...
                            <div class="flex items-center justify-between">
                                <button 
                                    class="mono-accent text-[11px] font-black uppercase tracking-[0.2em] text-white/40 hover:text-white transition-all hover:tracking-[0.3em] focus-visible:ring-2 focus-visible:outline-none focus-visible:ring-blue-500 rounded px-1"
